...
export default function DecryptedText({
  ...
  // Re-initializes display state whenever `text`/`animateOn` change (including
  // mount). Setting state directly here is intentional — this effect exists
  // solely to sync local state to those props, not to react to external systems.
